...
public class PropertySourcedRequestMappingHandlerMapping extends RequestMappingHandlerMapping {
	...
	private String mappingPath(final PropertySourcedMapping mapper) {
		...
		return Optional.fromNullable(environment.getProperty(key)).transform(new Function<String, String>() {
			@Override
	 ...
	 * <p>
	 * If no mapping is found, or if the URL is disabled, it will simply drop throug
	 * to the standard 404 handling.
	 * </p>
	 *
